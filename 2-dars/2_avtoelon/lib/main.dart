...
static List<Cars> samples = [
  Cars( 'Nexia','assets/3.jpg', "red1", 1,230 ),
  Cars( 'Lasetti','assets/5.jpg', "red2", 1,230 ),
  Cars( 'Cobalt','assets/1.jpg', "red3", 1,230 ),
  Cars( 'Tahoe','assets/2.jpg', "red4", 1,230 ),
  Cars( 'Equinox','assets/4.jpg', "red5", 1,230 ),
  Cars( 'Captiva','assets/3.jpg', "red5", 1,230 ),
];
